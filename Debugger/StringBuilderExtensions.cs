...
{
    /// <summary>
    /// 引用子雨松Momo博客https://www.xuanyusong.com/archives/4601
    ...
    public static class StringBuilderExtensions
    {
        ...
        {
            var type = string_builder.GetType();
            var fileInfo = type.GetField("_str",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            if (fileInfo != null)
            {
                var str = fileInfo.GetValue(string_builder);
                return (string)str;
            }
            else
            {
